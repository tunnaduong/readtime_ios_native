...
internal val logger: SkipLogger = SkipLogger(subsystem = "read.time", category = "ReadTime")

private typealias AppRootView = ReadTimeRootView
private typealias AppDelegate = ReadTimeAppDelegate
